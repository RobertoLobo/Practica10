...
public:
    ...
    QPushButton *btnRecorrer;
    QLineEdit *cVerticeInicial;
    QPushButton *btnRecorrer_2;
    QMenuBar *menubar;
    QMenu *menuA_adir;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        cSalidaGrafo->setGeometry(QRect(220, 180, 191, 111));
        ...
        btnRecorrer = new QPushButton(tab_4);
        btnRecorrer->setObjectName("btnRecorrer");
        btnRecorrer->setGeometry(QRect(220, 150, 80, 24));
        cVerticeInicial = new QLineEdit(tab_4);
        cVerticeInicial->setObjectName("cVerticeInicial");
        cVerticeInicial->setGeometry(QRect(220, 120, 101, 24));
        btnRecorrer_2 = new QPushButton(tab_4);
        btnRecorrer_2->setObjectName("btnRecorrer_2");
        btnRecorrer_2->setGeometry(QRect(330, 150, 80, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnRecorrer->setText(QCoreApplication::translate("MainWindow", "Recorrer DFS", nullptr));
        cVerticeInicial->setPlaceholderText(QCoreApplication::translate("MainWindow", "ID Vertice", nullptr));
        btnRecorrer_2->setText(QCoreApplication::translate("MainWindow", "Recorrer BFS", nullptr));
